...
| --- | --- | --- |
| [`gptjs`](https://github.com/beachdevs/gptjs) | JavaScript | JavaScript tooling |
| [`vanilla-light`](https://github.com/beachdevs/vanilla-light) | JavaScript | Full stack web framework |
| [`container`](https://github.com/beachdevs/container) | TypeScript | Container tooling |
| [`jsonc-data`](https://github.com/beachdevs/jsonc-data) | JavaScript | JSONC utilities |
| [`apicli`](https://github.com/beachdevs/apicli) | JavaScript | API CLI tooling |
